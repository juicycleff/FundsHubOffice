...
Template.SideNav.created = function() {

};

Template.SideNav.destroyed = function() {
...
Template.PrivateLayoutHeaderLeftMenu.rendered = function() {
	$(".menu-item-collapse .dropdown-toggle").each(function() {
		if($(this).find("li.active")) {
			$(this).removeClass("collapsed");
		}
...
Template.PrivateLayoutHeaderLeftMenu.events({
	"click .toggle-text": function(e, t) {
		e.preventDefault();
		$(e.target).closest("ul").toggleClass("menu-hide-text");
	}
...
Template.PrivateLayoutHeaderLeftMenu.helpers({
	
});

Template.PrivateLayoutHeaderRightMenu.rendered = function() {
	$(".menu-item-collapse .dropdown-toggle").each(function() {
		if($(this).find("li.active")) {
			$(this).removeClass("collapsed");
		}
...
Template.PrivateLayoutHeaderRightMenu.events({
	"click .toggle-text": function(e, t) {
		e.preventDefault();
		$(e.target).closest("ul").toggleClass("menu-hide-text");
	}
...
Template.PrivateLayoutHeaderRightMenu.helpers({
